...
function Swap({ rdt }) {
  ...
  async function handleSwap() {
    ...
    let manifest = new ManifestBuilder()
      ...
      .callMethod(COMPONENT_ADDRESS, "swap", [Bucket("token_a_bucket")])
      .callMethod(accountAddress, "deposit_batch", [Expression("ENTIRE_WORKTOP")])
      .build()
      .toString();
  
    console.log('swap token_a for token_b manifest: ', manifest)
  ...
  return (
    <>
      ...
      <div className="tradeBox">
        ...
        <div id="swapButton" className="swapButton" disabled={ !tokenOneAmount } onClick= { handleSwap }>Swap</div>
      </div>
    </>
  )
}
